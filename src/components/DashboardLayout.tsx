    ...
    <div className="flex h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="relative h-12 shrink-0 overflow-hidden border-b border-border bg-card/90 backdrop-blur supports-[backdrop-filter]:bg-card/75">
          ...
          <div className="relative z-10 h-full px-3">
            <div className="grid h-full grid-cols-[1fr_auto_1fr] items-center gap-4">
              {/* Left */}
              <div className="flex min-w-0 items-center gap-3">
                <button
                  onClick={() => setSidebarOpen(!sidebarOpen)}
                  className="shrink-0 rounded-xl p-2 text-foreground transition-colors hover:bg-secondary"
              ...
              <nav className="hidden items-center justify-center gap-3 md:flex">
                <a
                  href="/#overview-top"
                  className={`rounded-full border border-border px-4 py-1.5 text-xs font-semibold transition-all ${
                    isHomePage
              ...
              <div className="flex items-center justify-end gap-6">
                <div className="hidden md:flex items-center gap-1 rounded-full border border-border bg-background/60 px-2 py-1 text-[10px] text-muted-foreground">
                  <svg
